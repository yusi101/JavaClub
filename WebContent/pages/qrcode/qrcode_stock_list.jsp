...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form action="${pageContext.request.contextPath}/qrCodeController/queryQRCodeStocklistPage" method="post" name="queryEntnameInfo" id="queryEntnameInfo" class="form-horizontal" style="margin: 10px 0; height: 30px;">
