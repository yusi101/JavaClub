...
<body style="background-color: #333334">
	<script type="text/javascript" src="${pageContext.request.contextPath }/static/plugins/echarts/echarts.min.js"></script>
   	<script type="text/javascript" src="${pageContext.request.contextPath }/static/scripts/turnover/turnoverline2.js"></script>
   	<script type="text/javascript" src="${pageContext.request.contextPath }/static/scripts/turnover/turnoverpyramid2.js"></script>
    <form action="${pageContext.request.contextPath}/annualReportAnalysis2Controller/areaTurnoverAnalysis" method="POST" id="search">
   	...
   	<div class="title">南昌市各区域的2013-2015年度人员总数</div>
    ...
    $(function(){
    	...
    	industryname=industryname+"南昌市各区域的2013-2015年度人员总数";
