...
<body>
	...
	<div class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="NAME" placeholder="名称" value="${pd.NAME }" maxlength="20">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="BIANMA"><span style="color: red">*</span>编码</label>
			<div class="controls">
				<input type="text" id="BIANMA" placeholder="编码" value="${pd.BIANMA }" maxlength="20" >
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="ORDY_BY"><span style="color: red">*</span>序号</label>
			<div class="controls">
				<input type="number" id="ORDY_BY" onkeyup="value=value.replace(/^[0][0-9]*$/,'')" onblur="value=value.replace(/^[0][0-9]*$/,'')" placeholder="序号" value="${pd.ORDY_BY }" maxlength="4">
			</div>
		</div>
		<input type="hidden" id="ZD_ID" value="${pd.ZD_ID }">
		<div class="control-group">
			<div class="controls">
				<input type="button" class="btn btn-primary" id="add" value="保存" onclick="update()" />
