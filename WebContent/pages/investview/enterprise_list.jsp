...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form action="${pageContext.request.contextPath}/investViewController/queryEnteraddition" method="post" name="queryBrandInfo" id="queryBrandInfo" class="form-horizontal" style="margin: 10px 0; height: 30px;">
				...
				<tbody id="tbody">
					<c:forEach items="${Enteraddition}" var="list" varStatus="status">
						<tr>
							...
							<td>${list.ESTDATE }</td>
							<td class="dropdown">
								<a class="btn btn-detail" href="javascript:openInvestView('${list.PRIPID }','${list.REGNO }','${list.ENTNAME }','${list.ENTTYPE }')">投资链图</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
