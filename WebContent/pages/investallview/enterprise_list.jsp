...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form action="${pageContext.request.contextPath}/investAllViewController/queryEnteraddition" method="post" name="queryBrandInfo" id="queryBrandInfo" class="form-horizontal" style="margin: 10px 0; height: 30px;">
				...
				<tbody id="tbody">
					<c:forEach items="${Enteraddition}" var="list" varStatus="status">
						<tr>
							...
							<td>${list.ESTDATE }</td>
							<td class="dropdown">
								<a class="btn btn-detail" href="javascript:openInvestAllView('${list.PRIPID }','${list.REGNO }','${list.ENTNAME }','${list.ENTTYPE }')">投资全景</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
