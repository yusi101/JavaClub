...
public class Page implements Serializable{
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\" style=\"background: #62c462\" class=\"btn btn-mini btn-success\">跳转</a></li>\n");
	...
	public String getPageStrZJ() {
		StringBuffer sb = new StringBuffer();
		if(totalResult>0){
			sb.append("	<ul>\n");
			if(currentPage==1){
				sb.append("	<li style='padding-left:10px;color:#666666; font-size:14px;'><a>共<font color=red>"+totalResult+"</font>条</a></li>\n");
				sb.append("	<li><a>首页</a></li>\n");
				sb.append("	<li><a>上页</a></li>\n");
			}else{
				sb.append("	<li style='padding-left:10px;color:#666666; font-size:14px;'><a>共<font color=red>"+totalResult+"</font>条</a></li>\n");
