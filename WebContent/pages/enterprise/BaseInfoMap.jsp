...
<script type="text/javascript">
		...
		setTimeout(function(){
		 ...
		 function openInfo(PRIPID,e){
				...
				//alert("marker的位置是" + p.getPosition().lng + "," + p.getPosition().lat); 
				 $.ajax({
				url : '<%=request.getContextPath() %>/baseInfoMapController/findBaseInfoById',
				type : 'post',
				cache : false,
				data:{PRIPID:PRIPID},
		...
		function  getBaseInfo(C_COUNTY,C_COUNTY_CN){
			 ...
			 $.ajax({
					url : '<%=request.getContextPath() %>/baseInfoMapController/queryBaseInfoList',
					type : 'post',
					cache : false,
		...
		function geCity(C_AREA_LEVEL,C_CODE,type){
			$.ajax({
				url : '${pageContext.request.contextPath}/baseInfoMapController/queryCityList',
				type : 'post',
				cache : false,
		...
		function getCount(C_AREA_LEVEL,C_CODE){
			$.ajax({
				url : '${pageContext.request.contextPath}/baseInfoMapController/queryCount',
				type : 'post',
				cache : false,
				data : {C_AREA_LEVEL:C_AREA_LEVEL,C_CODE:C_CODE},
				success : function(text){
