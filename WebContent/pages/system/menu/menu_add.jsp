...
<body>
	<div class="form-horizontal" style="margin: 10px;">
		<table id="table_bug_report" class="table table-striped table-bordered table-hover">
				...
				<td style="text-align: left !important;">
					<div class="accordion-group" style="border: 0;">
						<div class="accordion-heading">
							<input type="text" name="PARENT_NAME" id="parentName" placeholder="请选择父级菜单" value="" title="请选择父级菜单" readonly="readonly" onclick="collapseOne();" />
							<input type="text" name="PARENT_ID" id="parentId" readonly="readonly" style="display: none;" />
							<input type="text" name="PARENT_TYPE" id="parentType" readonly="readonly" style="display: none;" />
						</div>
			...
			<tr>
				...
				<td style="text-align: left !important;">
					<div class="accordion-group" style="border: 0; width: 100%;">
						<div class="accordion-heading">
							<input type="text" name="MENU_ICON" id="menuIcon" placeholder="请选择菜单图标" value="" style="width: 80% !important;" title="请选择菜单图标" readonly="readonly" onclick="chooseIcon();" />
			...
			<tr>
				...
				<td style="text-align: left !important;">
					<input maxlength="20" type="text" name="MENU_NAME" id="menuName" placeholder="这里输入菜单名称" value="" title="名称" />
				</td>
			</tr>
			<tr>
				<td style="vertical-align: middle;width:60px;">链接地址</td>
				<td style="text-align: left !important;">
					<input type="text" name="MENU_URL" id="menuUrl" placeholder="这里输入链接地址" value="" title="地址" />
				</td>
			</tr>
			<tr>
	...
	<div class="layui-layer-btn">
		<a class="layui-layer-btn0" onclick="createMenu()">保存</a>
