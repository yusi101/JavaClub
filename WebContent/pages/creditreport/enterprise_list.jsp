...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form action="${pageContext.request.contextPath}/creditReportController/queryEnteraddition" method="post" name="queryBrandInfo" id="queryBrandInfo" class="form-horizontal" style="margin: 10px 0; height: 30px;">
				<div style="width: 100%; float: left; text-align: right;">
					...
					类型：<select placeholder="--请选择类别--" name="searchType" onchange="select(this)" id="selectType" style="width: 120px; text-align: center;">
				...
				<tbody id="tbody">
					<c:forEach items="${Enteraddition}" var="list" varStatus="status">
						<tr>
							...
							<td>${list.ESTDATE }</td>
							<td class="dropdown">
								<a class="btn btn-detail" href="javascript:opencredit('${list.PRIPID }','${list.ENTNAME }','${list.ENTTYPE }')">生成信用报告</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
