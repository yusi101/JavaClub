...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid" float:left;">
			<h4 class="title">编辑知识</h4>
			<table id="table_bug_report" class="table table-striped table-bordered table-hover">
					<tr>
						<th class="center" width="25%">标题</th>
						<th class="center">
							<input type="text" id="title" name="title"  maxlength="20" value="${list.get(0).TITLE }"/>
						</th>
					</tr>
					<tr >
						<th class="center" width="25%" >内容</th>
						<th class="center">
							<textarea style="min-height: 60px;" placeholder="请输入内容" type="text" name="content" id="content" maxlength="255" onkeyup="count();" oninput="this.style.height='0px';this.style.height=(this.scrollHeight+'px');">${list.get(0).CONTENT }</textarea>
					...
					<tr>
						...
						&nbsp;&nbsp;&nbsp;<input type="number"  name="MENU_ORDER" id="menuOrder" onkeyup="value=value.replace(/^[0][0-9]*$/,'')" onblur="value=value.replace(/^[0][0-9]*$/,'')" placeholder="这里输入序号" value="${list.get(0).ORDERBY }" title="序号"/>
						</td>
					</tr>
					<tr>
						<th class="center" colspan="2">
							<input type="button" class="btn btn-confirm" onclick="update('${list.get(0).ID }')" value="保存"/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
