...
/**
 * 热力图
 * @descript 通过热力图显示创业商机
 * @author 龚志强
 * @createTime 2016年11月29日下午4:38:45
 * @version 1.0
 */
@Controller
@RequestMapping(value = "/thermodynamicController")
public class ThermodynamicController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/creadThermodynamicPage", produces = "text/html;charset=UTF-8")
	@ResponseBody
	public ModelAndView creadThermodynamicPage() throws Exception {
		...
		mv.setViewName("industry/thermodynamic");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/queryThermodynamic", produces = "text/html;charset=UTF-8")
	@ResponseBody
	public String queryThermodynamic() throws Exception {
		PageData pd = new PageData();
		pd = this.getPageData();
