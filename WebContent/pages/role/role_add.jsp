		...
		<div class="row-fluid" style="width:60%;float:left;">
			...
			<table id="table_bug_report" class="table table-striped table-bordered table-hover">
					<tr>
						...
						<th class="center">
							<input type="text" id="role_Name" name="role_Name" style="width:50%;" maxlength="20"/>
						</th>
					</tr>
					<tr>
						<th class="center" width="25%">角色编码</th>
						<th class="center">
							<input type="text" id="role_Code" name="role_Code" style="width:50%;" maxlength="20"/>
						</th>
					</tr>
					<tr>
						...
						<th class="center">
							<div class="accordion-heading">
								<div name="menu_Name" id="menu_Name" style="font-weight: normal;text-align: left;"></div>
								<input type="text" name="menu_Id" id="menu_Id" readonly="readonly" style="display: none;" />
	...
	<script type="text/javascript">
		var setting = {
			...
			function setCheck() {
				...
				$.fn.zTree.init($("#menuList"), setting, ${Menujson});
			}
