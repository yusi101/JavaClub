...
<body style="background: rgb(245,245,245);">
		...
		<div class="qrcode_one">
			...
			<div class="qrcode_count">
				<div class="qrcode_count_top">
					...
					<div class="qrcode_round" style="margin: 44px 2.2% 43px 2.2%;"></div>
					...
					<div class="qrcode_round" style="margin: 44px 2.6% 43px 2.6%;"></div>
				...
				<div class="qrcode_count_bottom">
					...
					<div class="qrcode_round2" style="margin: 53px 2.5% 0px 2.5%;"></div>
					<div class="qrcode_count6" id="apply_counter_input">
						<span>0</span>（次）
						<p>在线录入</p>				
					</div>
					<div class="qrcode_round2" style="margin: 53px 4% 0px 3%;"></div>
		...
		<div class="qrcode_two" style="margin: 10px 0;">
			...
			<div class="qrcode_count" >
				<div class="qrcode_count_top2">
					<div class="qrcode_round3" style="margin: 41px 1% 0px 1%;"></div>
					<div class="qrcode_count8" id="qrcode_noauditing">
						<span>0</span>（块）
						<p>未审核的牌照数</p>
					</div>
					<div class="qrcode_round3" style="margin: 41px 1.6% 0px 1.6%;"></div>
					<div class="qrcode_count9" id="qrcode_noproduced">
						<span>0</span>（块）
						<p>未制作的牌照数</p>
					</div>
					<div class="qrcode_round3" style="margin: 41px 1.8% 0px 1.8%;"></div>
				...
				<div class="qrcode_count_bottom2">
					<div class="qrcode_round4" style="margin: 45px 1% 0px 1%;"></div>
					<div class="qrcode_count11" id="qrcode_alreadystorage">
						<span>0</span>（块）
						<p>库存的牌照数</p>				
					</div>
					<div class="qrcode_round4" style="margin: 45px 2.3% 0px 2.3%;"></div>
					<div class="qrcode_count12" id="qrcode_nonotice">
						<span>0</span>（块）
						<p>未通知的牌照数</p>
					</div>
					<div class="qrcode_round4" style="margin: 45px 2% 0px 2%;"></div>
	...
	<img src="${pageContext.request.contextPath }/static/images/sqlit.png">
	<div id="qrcode_industry_bar" style="height:500px; width: 93%; float:right; margin: 50px 4%; border-radius: 5px; background: #FFF;"></div>
