							...
							<form action="${pageContext.request.contextPath}/visitorController/createVisitor" method="post" name="visitorInfo" id="visitorInfo" class="form-horizontal" style="margin: 10px 0; height: 30px;">
								<table id="table_bug_report" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td><input type="text" id="visitorName" name="visitorName" style="width:50%;" maxlength="20"/></td>
										<td style="text-align:right;width:60px;">代表企业</td>
										<td><input type="text" id="entName" name="entName" style="width:50%;" maxlength="20"/></td>
									</tr>
									<tr>
										<td style="text-align:right;width:60px;">接待人</td>
										<td><input type="text" id="receiverName" name="receiverName" style="width:50%;" maxlength="20"/></td>
										<td style="text-align:right;width:60px;">接待时间</td>
										<td><input type="text" id="receivrTime" name="receivrTime" style="width:50%;" maxlength="20" placeholder="请选择接待时间" readonly="readonly"/></td>
									</tr>
									<tr>
										<td style="text-align:right;width:60px;">联系电话</td>
										<td colspan="3"><input type="text" id="tel" name="tel" style="width:50%;" maxlength="20"/></td>
									</tr>
									<tr>
										<td style="text-align:right;width:60px;">联系邮箱</td>
										<td colspan="3"><input type="text" id="email" name="email" style="width:50%;" maxlength="20"/></td>
									</tr>
									<tr>
										<td style="text-align:right;width:60px;">QQ</td>
										<td colspan="3"><input type="text" id="QQ" name="QQ" style="width:50%;" maxlength="20"/></td>
									</tr>
									<tr>
										<td colspan="4" style="text-align:right;"><input type="button" class="btn btn-confirm" onclick="add()" value="确定"/></td>
									</tr>
								</table>
							</form>
						</div>
